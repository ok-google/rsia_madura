...
<body>
	<div class="main-wrapper">
		<div class="app" id="app">
			<header class="header">
				<div class="nav-title">
					<h3 class="title">Transaksi</h3><small>Penerimaan Barang</small>
				</div>
					...
					<div class="container">
						...
						<div class="row card-block">
							<div class="col-6">
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Tgl. Terima Barang</label>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<div>
										<label>
											<input class="radio" name="aktif-kamar" type="radio">
											<span>Ya</span>
										</label>
										<label>
											<input class="radio" name="aktif-kamar" type="radio">
